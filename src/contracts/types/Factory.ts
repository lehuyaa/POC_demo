...
export interface FactoryInterface extends utils.Interface {
  functions: {
    ...
    "createPair(address,uint256,uint256,address,uint256,address[],uint256[],address)": FunctionFragment;
  ...
  events: {
    ...
    "CreatePair(address,uint256,address,uint256,uint256)": EventFragment;
...
export interface Factory extends BaseContract {
  ...
  filters: {
    ...
    "CreatePair(address,uint256,address,uint256,uint256)"(
      newPair?: null,
      index?: null,
      newOwner?: null,
      activityStart?: null,
