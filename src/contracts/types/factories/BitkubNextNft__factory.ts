...
import type { BitkubNextNft, BitkubNextNftInterface } from "../BitkubNextNft";
...
export class BitkubNextNft__factory {
  static readonly abi = _abi;
  static createInterface(): BitkubNextNftInterface {
    return new utils.Interface(_abi) as BitkubNextNftInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BitkubNextNft {
    return new Contract(address, _abi, signerOrProvider) as BitkubNextNft;
  }
}
