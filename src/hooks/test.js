...
// File contracts/interfaces/token/IKAP721Enumerable.sol
...
// File contracts/structs/DataFeedSubscriptionStructs.sol
...
// File contracts/interfaces/BitkubDataFeedInterface/DataFeedSubscriptionInterface.sol
...
interface DataFeedSubscriptionInterface {
    ...
    function packageDetails(uint256 _packageID)
        external
        view
    ...
    function packageDetailsByIDs(uint256[] calldata _packageIDs)
        external
        view
        returns (PackageDetails[] memory);
    ...
    function subscriptionRenewalAndMiscDetails(uint256 _tokenID)
        external
        view
        returns (SubscriptionRenewalAndMiscDetails memory);

    function subscriptionRenewalAndMiscDetailsByIDs(uint256[] memory _tokenIDs)
        external
        view
        returns (SubscriptionRenewalAndMiscDetails[] memory);

    function subscriptionPermissionDetails(uint256 _tokenID)
        external
        view
        returns (SubscriptionPermissionDetails memory);

    function subscriptionPermissionDetailsByIDs(uint256[] memory _tokenIDs)
        external
        view
        returns (SubscriptionPermissionDetails[] memory);

    function subscriptionDetails(uint256 _tokenID)
        external
        view
        returns (SubscriptionDetails memory);

    function subscriptionDetailsByIDs(uint256[] memory _tokenIs)
        external
        view
        returns (SubscriptionDetails[] memory);
    ...
    function isSubscribed(uint256 _tokenID, address _dataFeedAddr)
        external
        view
        returns (bool);

    // returns SubscriptionPermissionDetails.readerCount
    function getMaximumReaderCount(uint256 _tokenID)
        external
        view
        returns (uint256);
}
...
// File contracts/interfaces/BitkubDataFeedInterface/DataFeedSubscriptionAdminInterface.sol


pragma solidity ^0.8.0;
interface DataFeedSubscriptionAdminInterface {
  event PackageAdded(uint256 indexed packageID, address indexed caller, PackageDetails packageDetails);
  ...
  // super admin
  function updatePackage(uint256 _packageID, PackageDetails calldata _packageDetails) external;

  // super admin
  function disablePackage(uint256 _packageID, bool _disabled) external;

  // committee
  function editSubscription(uint256 _tokenID, SubscriptionDetails calldata _subscriptionDetails) external;
...
// File contracts/interfaces/token/IKAP721Metadata.sol
...
// File contracts/interfaces/BitkubDataFeedInterface/BitkubDataFeedNFTInterface.sol


pragma solidity >=0.6.0 <0.9.0;
interface BitkubDataFeedNFTInterface is IKAP721, IKAP721Metadata, IKAP721Enumerable {
  event AllowedAddressAdded(address indexed allowedAddr, address indexed caller);
  event AllowedAddressRemoved(address indexed allowedAddr, address indexed caller);
  ...
  function allowedAddr(uint256 _page, uint256 _limit) external view returns (address[] memory);
  ...
  function tokenOfOwnerByTokenInfo(address _owner, address _infoAddr) external view returns (uint256[] memory);

  function balanceOfByTokenInfo(address _owner, address _infoAddr) external view returns (uint256);
...
// File contracts/interfaces/BitkubDataFeedInterface/DataFeedTypeInterface.sol


pragma solidity ^0.8.0;

interface DataFeedTypeInterface {
  event AddressAdded(uint256 indexed dataFeedType, address indexed addedAddress, address indexed caller);

  event AddressRemoved(uint256 indexed dataFeedType, address indexed removedAddress, address indexed caller);

  function setAddresses(uint256 _dataFeedType, address[] memory _dataFeedAddrs) external;

  function addAddresses(uint256 _dataFeedType, address[] memory _dataFeedAddrs) external;

  function removeAddresses(uint256 _dataFeedType, address[] memory _dataFeedAddrs) external;

  function setDataFeedDescription(uint256 _dataFeedType, string memory _description) external;

  function inDataFeedType(uint256 _dataFeedType, address _dataFeedAddr) external view returns (bool);

  function activeDataFeedTypesCount() external view returns (uint256);

  function activeDataFeedTypes() external view returns (uint256[] memory dataFeedTypes);

  function activeDataFeedTypesByPage(uint256 _page, uint256 _limit)
    external
    view
    returns (uint256[] memory dataFeedTypes);

  function dataFeedTypeDescription(uint256 _dataFeedType) external view returns (string memory);

  function addressesCountByDataFeedType(uint256 _dataFeedType) external view returns (uint256);

  // right now _dataFeedType = 1 shoud do...
  // returns all addresses of this dataFeedType
  function addressesByDataFeedType(uint256 _dataFeedType) external view returns (address[] memory);
...
// File contracts/interfaces/IAdminKAP20Router.sol
...
// File contracts/DataFeedSubscription.sol
    ...
    DataFeedSubscriptionAdminInterface
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////
    function setAdminKAP20Router(address _adminKAP20Router)
        external
        onlyCommittee
    {
    ...
    function setBitkubDataFeedNFT(address _bitkubDataFeedNFT)
        external
        onlySuperAdmin
    {
    ...
    function addPackage(PackageDetails memory _details)
        external
        override
        onlySuperAdmin
    {
    ...
    function updatePackage(uint256 _packageID, PackageDetails memory _details)
        external
        override
        onlySuperAdmin
    {
    ...
    function disablePackage(uint256 _packageID, bool _disabled)
        external
        override
        onlySuperAdmin
    {
    ...
    function disableSubscription(uint256 _tokenID, bool _disabled)
        external
        override
        onlySuperAdmin
    {
    ...
    function subscriptionDetailsByIDs(uint256[] memory _tokenIDs)
        external
        view
        override
        returns (SubscriptionDetails[] memory)
    ...
    // metamask
    function subscribe(uint256 _packageID)
        external
        override
        whenNotPaused
        nonReentrant
    ...
    // bitkubNext only
    function subscribe(uint256 _packageID, address _bitkubNext)
        external
        override
        onlySuperAdmin
        whenNotPaused
    ...
    // metamask
    function renew(uint256 _tokenID)
        external
        override
        whenNotPaused
    ...
    // bitkubNext only
    function renew(uint256 _tokenID, address _bitkubNext)
        external
        override
        onlySuperAdmin
        whenNotPaused
